...
<head>
    ...
    <title>Create faculty account — UIU Compliance Management Platform</title>
...
<main class="auth-wrap">
    ...
    <section class="auth-card">
        ...
        <form method="POST" action="../backend/actions/signup-faculty.php" class="auth-form">
            ...
            <div class="field">
                <label for="fid">Employee ID</label>
                <div class="input">
                    <i class="fa-solid fa-id-badge" aria-hidden="true"></i>
                    <input id="fid" name="fid" type="text" placeholder="e.g. EMP-00123" required>
                </div>
            </div>
