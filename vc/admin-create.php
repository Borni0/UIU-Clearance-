...
<head>
    ...
    <title>Add Admin — UIU Compliance Management Platform</title>
...
<div class="layout">
    ...
    <main class="main">
        ...
        <div class="page-head">
            <h1>Add an admin</h1>
            <p>Create a new department admin account. They will sign in with the email and temporary password you set.</p>
            <div class="actions">
        ...
        <section class="card">
            <form method="POST" action="../backend/actions/vc-create-admin.php">
                ...
                <div class="field">
                    ...
                    <div class="input">
                        ...
                        <input id="fullname" name="fullname" type="text" placeholder="e.g. Dr. Kamal Hossain" required>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="input">
                        ...
                        <input id="dept" name="dept" type="text" placeholder="e.g. Administration" required>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="input">
                        ...
                        <input id="eid" name="eid" type="text" placeholder="e.g. EMP-00123" required>
                    </div>
                </div>
                ...
                <div class="grid grid-2" style="gap: 16px;">
                    <div class="field" style="margin-bottom: 0;">
                        ...
                        <span class="field-hint">Shown to the admin on first login. Must be at least 8 characters.</span>
                    </div>
                    <div class="field" style="margin-bottom: 0;">
